<?
 ...
 if(!$_REQUEST['ELEMENT_CODE']) {
	...
	$APPLICATION->SetPageProperty('mobile_title', '<strong>Әйелдер үшін</strong><span>Егер ол ЭД-мен сырқаттанса,<br>қалай көмектесуге болады?</span>');
 ?>
	...
	<div id="woman">
     <div class="woman-title" style="background-image: url(/layout/images/woman.jpg)">
       ...
       <div class="content">
		<h1>СІЗДІҢ ЕРКЕГІҢІЗДЕ ЭД БАР ЕКЕНІН ҚАЛАЙ ТҮСІНУГЕ БОЛАДЫ?</h1>
		<p>
			Еркегіңізде Эректильді Дисфункция пайда болды ма деп қобалжып жүрсіз бе? Сексуалдық өмірлеріңізде барлығы дұрыс екеніне сенімді болғыңыз келеді ме ? Мына қарапайым тест сіздің еркегіңізге болжамды қиындықтарға қатысты қобалжудың орынды екенін немесе дабыл қағуға ешбір себептің жоқ екенін түсінуге көмектеседі.
		</p>
		<a href="/test/woman_kz/" class="red-button">ТЕСТТІ БАСТАУ</a>
       </div>
      </div>
     </div>
